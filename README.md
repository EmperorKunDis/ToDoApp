Zde je přeformátovaný text pro GitHub `README.md` soubor:
...
**NOTE**:
If you run into issues installing the dependencies with NPM, use this below command:
...
- Put your Social Media URL on each `href`
